...
window.Chart=function(domId){
    ...
    $this.ratePieNoAnimation=function(number){
        ...
        grd.addColorStop(0.3, "#f8fafb");
        grd.addColorStop(0.6, "#f8fafb");
        grd.addColorStop(1, "#f8fafb");
        ...
        grd.addColorStop(0, "#2e9eb4");
        grd.addColorStop(0.3, "#2e9eb4");
        grd.addColorStop(0.6, "#2e9eb4");
        grd.addColorStop(1, "#2e9eb4");
        ctx.strokeStyle = grd;
        ctx.lineWidth=outW+1;
